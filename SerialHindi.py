    ...
    while True:
        ...
        if data:
            if data == '1':
                ...
                run_script_with_sound('capture.py', 'image_capture_hindi.mp3')
                # Run model.py script with "Processing the image" sound in Hindi
                run_script_with_sound('model.py', 'image_processing_hindi.mp3')
                ...
                run_scripts('playHindi.py', 'draw.py', *detection_results)
            else:
